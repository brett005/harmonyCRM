                    ...
                    <div class="row">
                        <div class="predefined_styles">
                            <div class="swichermainleft text-center">
                               <!--  <div class="p-3">
                                    <a href="index" class="btn ripple btn-primary btn-block mt-0" target="blank" >View Demo</a>
                                    <a href="https://themeforest.net/item/dayone-django-admin-dashboard-template/35115196" class="btn ripple btn-secondary btn-block">Buy Now</a>
                                ...
                                <div class="skin-body switch_section">
                                    ...
                                    <!-- <div class="switch-toggle d-flex mt-2">
                                        <a class="bg-img1" href="javascript:void(0);" onclick="bgImage(this)"><img
                                                src="../../../../static assets/images/photos/bg-img1.jpg" alt="Bg-Image" id="bgimage1"></a>
                                        <a class="bg-img2" href="javascript:void(0);" onclick="bgImage(this)"><img
                                                src="../../../../static assets/images/photos/bg-img2.jpg" alt="Bg-Image" id="bgimage2"></a>
                                        <a class="bg-img3" href="javascript:void(0);" onclick="bgImage(this)"><img
                                                src="../../../../static assets/images/photos/bg-img3.jpg" alt="Bg-Image" id="bgimage3"></a>
                                        <a class="bg-img4" href="javascript:void(0);" onclick="bgImage(this)"><img
                                                src="../../../../static assets/images/photos/bg-img4.jpg" alt="Bg-Image" id="bgimage4"></a>
                                    </div> -->
                                </div>
                            </div>
                            <div class="swichermainleft">
                            ...
                            <div class="swichermainleft">
                                ...
                                <div class="skin-body">
                                    <div class="switch_section my-4">
                                        <button class="btn btn-danger btn-block" id="resetAll" type="button">Reset All</button>
                                    </div>
                                </div>
                            </div>
                        </div>
