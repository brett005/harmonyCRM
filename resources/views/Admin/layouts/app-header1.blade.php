					...
					<div class="container-fluid main-container" id="headerhor">
						<div class="d-flex">
							...
							<!--<div class="mt-0">
								...
								<div>
                                   <!--<a href="javascript:void(0);" class="btn btn-pill btn-secondary"> Raccrocher et qualifier</a>-->
                                   <a href="javascript:void(0);"  class="btn btn-pill btn-secondary"><i class="si si-call-end" data-bs-toggle="tooltip" title="" data-bs-original-title="si-call-end" aria-label="si-call-end"></i></a>
                                 </div>
									...
									<div class="collapse navbar-collapse" id="navbarSupportedContent-4">
										<div class="d-flex ms-auto">
											<a class="nav-link  icon p-0 nav-link-lg d-lg-none navsearch"  href="javascript:void(0);" data-bs-toggle="search">
                                                ...
                                                <a href="javascript:void(0);"  class="btn btn-danger btn-circle btn-xl"><i class="si si-call-end" data-bs-toggle="tooltip" title="" data-bs-original-title="si-call-end" aria-label="si-call-end"></i></a>
                                                 <a href="javascript:void(0);"  class="btn btn-pill btn-secondary"><i class="si si-call-end" data-bs-toggle="tooltip" title="" data-bs-original-title="si-call-end" aria-label="si-call-end"></i></a>
                                           </div>
