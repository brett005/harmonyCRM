                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table  table-vcenter text-nowrap table-bordered border-bottom" id="hr-table">
                            <thead>
                            <tr>
                                <th class="border-bottom-0 w-5">Carrier ID</th>
                                <th class="border-bottom-0">	Carrier Name</th>
                                <th class="border-bottom-0 w-10"> 	Server IP</th>
                                <th class="border-bottom-0 w-10"> 	Protocol</th>
                                <th class="border-bottom-0 w-10"> 	Registration </th>
                                <th class="border-bottom-0 w-10"> 	   Active  </th>
                                 <th class="border-bottom-0 w-10"> 	   ADMIN GROUP </th>
