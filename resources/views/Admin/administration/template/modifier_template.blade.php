            ...
            <div class="tab-menu-heading hremp-tabs p-0 ">
                <div class="tabs-menu1">
                    ...
                    <ul class="nav panel-tabs">
                        <li class="ms-4"><a href="#tab5" class="active" data-bs-toggle="tab"><i class="fa fa-phone" data-bs-toggle="tooltip" title="" data-bs-original-title="fa fa-phone" aria-label="fa fa-phone"></i>ModifierTemplate </a>
                        </li>
                    </ul>
                </div>
            </div>
                        ...
                        <div class="card-body">
                            ...
                            <form action="ajouter-phone" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-2">
                                            <label class="form-label mb-0 mt-2">Template ID:</label>
                                        </div>
                                        <div class="col-md-4">
                                         ...
                                         <div class="col-md-2">
                                            <label class="form-label mb-0 mt-2">Template Name:</label>
                                        </div>
                                        <div class="col-md-4">
                                ...
                                <div class="form-group ">
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            <label class="form-label mb-0 mt-2">Template Contents: </label>
                                        </div>
                                        <div class="col-md-4">
