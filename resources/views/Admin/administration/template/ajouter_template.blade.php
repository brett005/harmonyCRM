            ...
            <div class="tab-menu-heading hremp-tabs p-0 ">
                <div class="tabs-menu1">
                    ...
                    <ul class="nav panel-tabs">
                        <li class="ms-4"><a href="#tab5" class="active" data-bs-toggle="tab"><i class="fa fa-phone" data-bs-toggle="tooltip" title="" data-bs-original-title="fa fa-phone" aria-label="fa fa-phone"></i>Ajouter Template </a>
                        </li>
                    </ul>
                </div>
            </div>
