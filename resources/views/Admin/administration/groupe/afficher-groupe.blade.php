...
<div class="side-app main-container">
                        ...
                        <div class="page-header d-xl-flex d-block">
                            <div class="page-leftheader">
                                <div class="page-title">afficher groupe</div>
                            </div>
                            ...
                            <div class="col-xl-12 col-md-12 col-lg-12">
                                <div class="card">
                                    <div class="card-header  border-0">
                                        <h4 class="card-title">Afficher les groupes des utilisateurs</h4>
                                    </div>
                                    <div class="card-body">
                                        <div class="table-responsive">
                                            <table class="table  table-vcenter text-nowrap table-bordered border-bottom" id="hr-table">
                                                <thead>
                                                    <tr>
                                                        <th class="border-bottom-0 w-5">Groupe d'utilisateur</th>
                                                        <th class="border-bottom-0">Nom du groupe</th>
                                                        <th class="border-bottom-0 w-10">   Forcer l'horloge </th>
