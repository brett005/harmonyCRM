                        ...
                        <div class="page-header d-xl-flex d-block">
							<div class="page-leftheader">
								<div class="page-title">
                                  Modification groupée du groupe d'utilisateurs</div>
							</div>
										...
										<div class="tab-pane active" id="tab5">
											<div class="card-body">
                                                <div class="form-group">
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <label class="form-label mb-0 mt-2"> Modifier les utilisateurs dans ce groupe </label>
                                                        </div>
                                                        <div class="col-md-6">
												...
												<div class="form-group ">
													...
													<div class="row">
														...
														<div class="col-md-6">
															<label class="form-label mb-0 mt-2">  à ce groupe </label>
														</div>
														<div class="col-md-6">
...
Remplacez TOUS les utilisateurs non-administrateurs par ce groupe </label>
														</div>
														<div class="col-md-6">
															<input type="text" class="form-control"  placeholder="">
														</div>
