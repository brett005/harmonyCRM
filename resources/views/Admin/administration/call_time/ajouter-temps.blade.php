            ...
            <div class="tab-menu-heading hremp-tabs p-0 ">
                <div class="tabs-menu1">
                    ...
                    <ul class="nav panel-tabs">
                        <li class="ms-4"><a href="#tab5" class="active" data-bs-toggle="tab"><i class="fa fa-phone" data-bs-toggle="tooltip" title="" data-bs-original-title="fa fa-phone" aria-label="fa fa-phone"></i> Ajouter un  temps d'appel</a>
                        </li>
                    </ul>
                </div>
            </div>
            <div class="panel-body tabs-menu-body hremp-tabs1 p-0">
                <div class="tab-content">
                    <div class="tab-pane active" id="tab5">
                        <div class="card-body">
                            <h4 class="mb-4 font-weight-bold"> <i class="fa fa-phone" data-bs-toggle="tooltip" title="" data-bs-original-title="fa fa-phone" aria-label="fa fa-phone"></i>  Formulaire temps d'appel</h4>
                            <form action="ajouter-phone" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-2">
                                            <label class="form-label mb-0 mt-2">ID de temps d'appel </label>
                                        </div>
                                        <div class="col-md-4">
                                         ...
                                         <div class="col-md-2">
                                            <label class="form-label mb-0 mt-2">Nom de l'heure d'appel </label>
                                        </div>
                                        <div class="col-md-4">
                                ...
                                <div class="form-group ">
                                    <div class="row">
                                        <div class="col-md-2">
                                            <label class="form-label mb-0 mt-2">Commentaires sur l'heure d'appe</label>
                                        </div>
                                        <div class="col-md-4">
