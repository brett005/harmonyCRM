...
<div class="side-app main-container">
                        ...
                        <div class="page-header d-xl-flex d-block">
                            <div class="page-leftheader">
                                <div class="page-title">Mélange liste</div>
                            </div>
                                    ...
                                    <div class="card-body">
                                        <div class="table-responsive">
                                            <table class="table  table-vcenter text-nowrap table-bordered border-bottom" id="hr-table">
                                                <thead>
                                                    <tr>
                                                        <th class="border-bottom-0 w-5">EN GROUPE</th>
                                                        <th class="border-bottom-0">Nom </th>
                                                        <th class="border-bottom-0 w-10">   PRIORITÉ</th>
                                                        <th class="border-bottom-0 w-10">   ACTIF</th>
                                                        <th class="border-bottom-0 w-10"> GROUPE D'ADMINISTRATION</th>
                                                        <th class="border-bottom-0 w-10"> TEMPS</th>
                                                        <th class="border-bottom-0 w-10"> COULEURS</th>
