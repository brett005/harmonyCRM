                    ...
                    <div class="side-app main-container">
                        ...
                        <div class="page-header d-xl-flex d-block">
							<div class="page-leftheader">
                               ...
                               AJOUTER OU SUPPRIMER DES NUMÉROS DE LA LISTE DES GROUPES DE TÉLÉPHONE FILTRE</div>
							</div>
									...
									<div class="tab-content">
										<div class="tab-pane active" id="tab5">
											<div class="card-body">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-4">
                                                            <label class="form-label mb-0 mt-2">Filtrer le groupe de téléphone </label>
                                                        </div>
                                                        <div class="col-md-6">
                                                ...
                                                <div class="form-group ">
													...
													<div class="row">
														...
														<div class="col-md-4">
															<label class="form-label mb-0 mt-2">Numéros de téléphone </label>
														</div>
														<div class="col-md-6">
                                                 ...
                                                 <div class="form-group">
                                                    <div class="row">
                                                        <div class="col-md-4">
                                                            <label class="form-label mb-0 mt-2">Ajouter ou supprimer </label>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <select name="projects"  class="form-control custom-select select2" data-placeholder="Oui">
                                                                <option label="Oui"></option>
