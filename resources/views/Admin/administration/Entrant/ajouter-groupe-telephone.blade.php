                    ...
                    <div class="side-app main-container">
                        ...
                        <div class="page-header d-xl-flex d-block">
							<div class="page-leftheader">
								<div class="page-title">Ajouter un groupe de téléphones de filtrage</div>
							</div>
										...
										<div class="tab-pane active" id="tab5">
											<div class="card-body">
                                                <div class="form-group">
                                                    <div class="row">
                                                        <div class="col-md-4">
                                                            <label class="form-label mb-0 mt-2">Filtrer l'ID du groupe de téléphones</label>
                                                        </div>
                                                        <div class="col-md-6">
												...
												<div class="form-group ">
													...
													<div class="row">
														...
														<div class="col-md-4">
															<label class="form-label mb-0 mt-2">Filtrer le nom du groupe de téléphones</label>
														</div>
														<div class="col-md-6">
										     ...
										     <div class="form-group">
                                                    <div class="row">
                                                        <div class="col-md-4">
                                                            <label class="form-label mb-0 mt-2">Filtrer la description du groupe de téléphones  </label>
                                                        </div>
                                                        <div class="col-md-6">
                                                            	<input type="text" class="form-control mb-md-0 mb-5"  placeholder="Nom">
                                                        </div>
