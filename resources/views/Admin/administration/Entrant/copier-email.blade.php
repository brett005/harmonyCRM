s@extends('Admin.layouts.hr-base')
@section('admin')
                    ...
                    <div class="side-app main-container">
                        ...
                        <div class="page-header d-xl-flex d-block">
							<div class="page-leftheader">
								<div class="page-title">Copier le groupe d'email</div>
							</div>
											...
											<div class="card-body">
												...
												<div class="form-group ">
													...
													<div class="row">
														...
														<div class="col-md-4">
															<label class="form-label mb-0 mt-2">Nom du groupe de messagerie </label>
														</div>
														<div class="col-md-6">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-4">
                                                            <label class="form-label mb-0 mt-2">ID du groupe d'e-mails source </label>
                                                        </div>
                                                        <div class="col-md-6">
