                    ...
                    <div class="side-app main-container">
                        ...
                        <div class="page-header d-xl-flex d-block">
							<div class="page-leftheader">
								<div class="page-title">AJOUTER UN NOUVEAU DE GROUPE discussion</div>
							</div>
										...
										<div class="tab-pane active" id="tab5">
											<div class="card-body">
                                                <div class="form-group">
                                                    <div class="row">
                                                        <div class="col-md-4">
                                                            <label class="form-label mb-0 mt-2">ID du groupe </label>
                                                        </div>
                                                        <div class="col-md-6">
												...
												<div class="form-group ">
													...
													<div class="row">
														...
														<div class="col-md-4">
															<label class="form-label mb-0 mt-2">Nom du groupe </label>
														</div>
														<div class="col-md-6">
												...
												<div class="form-group ">
													<div class="row">
														<div class="col-md-4">
															<label class="form-label mb-0 mt-2">Couleur du groupe </label>
														</div>
														<div class="col-md-6">
										     ...
										     <div class="form-group">
												...
												<div class="form-group ">
													<div class="row">
														<div class="col-md-4">
															<label class="form-label mb-0 mt-2">ID DE LISTE PAR DEFAULT</label>
														</div>
														<div class="col-md-6">
															<select name="projects"  class="form-control custom-select select2" data-placeholder="Oui">
                                                                <option label="Oui"></option>
												...
												<div class="form-group ">
													<div class="row">
														<div class="col-md-4">
															<label class="form-label mb-0 mt-2">Formulaire web </label>
														</div>
														<div class="col-md-6">
                                                ...
                                                <div class="form-group ">
													...
													<div class="row">
														...
														<div class="col-md-4">
															<label class="form-label mb-0 mt-2">Prochain chat avec l'agent    </label>
														</div>
														<div class="col-md-6">
												...
												<div class="form-group">
                                                    <div class="row">
                                                        <div class="col-md-4">
                                                            <label class="form-label mb-0 mt-2">Affichage frontal  </label>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <select name="projects"  class="form-control custom-select select2" data-placeholder="Oui">
                                                                <option label="Oui"></option>
                                                ...
                                                <div class="form-group">
                                                    <div class="row">
                                                        <div class="col-md-4">
                                                            <label class="form-label mb-0 mt-2">Scénario  </label>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <select name="projects"  class="form-control custom-select select2" data-placeholder="Oui">
                                                                <option label="Oui"></option>
                                                ...
                                                <div class="form-group">
                                                    <div class="row">
                                                        <div class="col-md-4">
                                                            <label class="form-label mb-0 mt-2">Obtenir le lancement d'appel  </label>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <select name="projects"  class="form-control custom-select select2" data-placeholder="Oui">
                                                                <option label="Oui"></option>
