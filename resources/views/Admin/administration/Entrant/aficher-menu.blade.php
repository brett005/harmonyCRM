                            ...
                            <div class="col-xl-12 col-md-12 col-lg-12">
                                <div class="card">
                                    <div class="card-header  border-0">
                                        <h4 class="card-title">LISTES DU MENU D'APPEL :</h4>
                                    </div>
                                    <div class="card-body">
                                        <div class="table-responsive">
                                            <table class="table  table-vcenter text-nowrap table-bordered border-bottom" id="hr-table">
                                                <thead>
                                                    <tr>
                                                        <th class="border-bottom-0 w-5">ID MENU</th>
                                                        <th class="border-bottom-0">Nom </th>
                                                        <th class="border-bottom-0 w-10">   GROUPE  RAPIDE</th>
                                                         <th class="border-bottom-0 w-10">      TEMPS LIBRE</th>
