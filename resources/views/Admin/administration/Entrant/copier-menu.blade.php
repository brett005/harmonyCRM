                    ...
                    <div class="side-app main-container">
                        ...
                        <div class="page-header d-xl-flex d-block">
							<div class="page-leftheader">
								<div class="page-title">Copier le menu d'appel</div>
							</div>
										...
										<div class="tab-pane active" id="tab5">
											<div class="card-body">
                                                <div class="form-group">
                                                    <div class="row">
                                                        <div class="col-md-4">
                                                            <label class="form-label mb-0 mt-2">Identifiant du menu  </label>
                                                        </div>
                                                        <div class="col-md-6">
												...
												<div class="form-group ">
													...
													<div class="row">
														...
														<div class="col-md-4">
															<label class="form-label mb-0 mt-2">Nom du menu  </label>
														</div>
														<div class="col-md-6">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-4">
                                                            <label class="form-label mb-0 mt-2">Menu sources </label>
                                                        </div>
                                                        <div class="col-md-6">
