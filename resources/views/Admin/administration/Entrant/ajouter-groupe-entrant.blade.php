                    ...
                    <div class="side-app main-container">
                        ...
                        <div class="page-header d-xl-flex d-block">
							<div class="page-leftheader">
								<div class="page-title">AJOUTER UN NOUVEAU GROUPE ENTRANT</div>
							</div>
											...
											<div class="card-body">
										     ...
										     <div class="form-group">
												...
												<div class="form-group ">
                                                    <div class="row">
                                                        <div class="col-md-4">
                                                            <label class="form-label mb-0 mt-2">Messagerie vocale</label>
                                                        </div>
                                                        <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    <div class="row">
                                                        <div class="col-md-4">
                                                            <label class="form-label mb-0 mt-2">Prochain appel de l'agent  </label>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <select name="projects"  class="form-control custom-select select2" data-placeholder="Oui">
                                                                <option label="Oui"></option>
