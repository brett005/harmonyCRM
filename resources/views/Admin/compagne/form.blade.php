                ...
                <div class="card-body pb-2">
                    ...
                    <div class="row row-sm">
                        ...
                        <div class="col-lg mg-t-10">
                            <textarea class="form-control mb-4" placeholder="Textarea (readonly)" readonly=""
                                      rows="3"></textarea>
                        </div>
                        <div class="col-lg mg-t-10">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control mb-4 is-valid state-valid"
                                              placeholder="Textarea (success state)" required="" rows="3">This is textarea</textarea>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control mb-4 is-invalid state-invalid"
                                              placeholder="Textarea (invalid state)" required="" rows="3"></textarea>
                                </div>
                            </div>
                        </div>
                    </form>
                    ...
                    <div class="card-pay">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active show" id="tab20">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control" placeholder="Search for...">
                                        <span class="input-group-append">
																<button class="btn btn-secondary box-shadow-0"><i
                            ...
                            <div class="tab-pane" id="tab21">
                                ...
                                <p><a href="javascript:void(0);" class="btn btn-primary"><i class="fa fa-paypal"></i>
