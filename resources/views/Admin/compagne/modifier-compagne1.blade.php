    ...
    <div class="app-content main-content">
        <div class="side-app main-container">
            ...
            <div class="page-header d-xl-flex d-block">
                ...
                <div class="page-rightheader ms-md-auto">
                    <div class="align-items-end flex-wrap my-auto right-content breadcrumb-right">
                        <div class="btn-list">
                            <a href="hr-addemployee" class="btn btn-primary me-3">Add New Employee</a>
                            ...
                            <div class="row">
                                <div class="col-7">
                                    <div class="mt-0 text-start"><span
                                            class="font-weight-semibold">Total Employees</span>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-7">
                                    <div class="mt-0 text-start"><span
                                            class="font-weight-semibold">Total Male Employees</span>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-7">
                                    <div class="mt-0 text-start"><span
                                            class="font-weight-semibold">Total New Employees</span>
            ...
            @section('script')
                ...
                <!-- INTERNAL INDEX JS -->
                <script src="{{asset('assets/js/hr/hr-empview.js')}}"></script>
