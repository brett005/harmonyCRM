                    ...
                    <div class="side-app main-container">
                        ...
                        <div class="page-header d-xl-flex d-block">
							<div class="page-leftheader">
								<div class="page-title">Ajouter un agent distant</div>
							</div>
									...
									<div class="tab-content">
										<div class="tab-pane active" id="tab5">
											<div class="card-body">
                                                <div class="form-group">
                                                    <div class="row">
                                                        <div class="col-md-3">
                                                            <label class="form-label mb-0 mt-2">Début de l'ID utilisateur</label>
                                                        </div>
                                                        <div class="col-md-6">
												...
												<div class="form-group ">
													...
													<div class="row">
														...
														<div class="col-md-3">
															<label class="form-label mb-0 mt-2">Nombre de lignes </label>
														</div>
														<div class="col-md-6">
												...
												<div class="form-group ">
													<div class="row">
														<div class="col-md-3">
															<label class="form-label mb-0 mt-2">Poste externe </label>
														</div>
														<div class="col-md-6">
										...
										<div class="form-group ">
												...
												<div class="form-group ">
													<div class="row">
														<div class="col-md-3">
															<label class="form-label mb-0 mt-2">Campagne</label>
														</div>
														<div class="col-md-6">
															<select name="projects"  class="form-control custom-select select2" data-placeholder="Oui">
                                                                <option label="Oui"></option>
                                                ...
                                                <div class="form-group ">
													...
													<div class="row">
														...
														<div class="col-md-3">
															<label class="form-label mb-0 mt-2">Groupes entrants </label>
														</div>
														<div class="col-md-6">
