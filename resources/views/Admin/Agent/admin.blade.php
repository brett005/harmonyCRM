...
@extends('layouts.superadmin-base')
@section('admin') 
							...
							<div class="col-xxl-3 col-xl-3 col-lg-3 col-md-3">
								<div class="card">
									<div class="card-body">
										<div class="row">
											<div class="col-8">
												<div class="mt-0 text-start"> <span class="font-weight-semibold">Agent ayant produis </span>
							...
							<div class="col-xxl-3 col-xl-3 col-lg-3 col-md-3">
								<div class="card">
									<div class="card-body">
										<div class="row">
											<div class="col-8">
												<div class="mt-0 text-start"> <span class="font-weight-semibold">Compagnes en cours</span>
							...
							<div class="col-xxl-3 col-xl-3 col-lg-3 col-md-3">
								<div class="card">
									<div class="card-body">
										<div class="row">
											<div class="col-8">
												<div class="mt-0 text-start"> <span class="font-weight-semibold">Heures de  production</span>
							...
							<div class="col-xxl-3 col-xl-3 col-lg-3 col-md-3">
								<div class="card">
									<div class="card-body">
										<div class="row">
											<div class="col-8">
												<div class="mt-0 text-start"> <span class="font-weight-semibold">Fichiers en cours </span>
								...
								<div class="col-xxl-3 col-xl-3 col-lg-3 col-md-3">
									<div class="card">
										<div class="card-body">
											<div class="row">
												<div class="col-8">
													<div class="mt-0 text-start"> <span class="font-weight-semibold">Argumentés</span>
														<h3 class="mb-0 mt-1 text-success mb-2">6,578</h3>
													</div>
												</div>
												<div class="col-4">
								...
								<div class="col-xxl-3 col-xl-3 col-lg-3 col-md-3">
									<div class="card">
										<div class="card-body">
											<div class="row">
												<div class="col-8">
													<div class="mt-0 text-start"> <span class="font-weight-semibold">Positifs</span>
													<h3 class="mb-0 mt-1 text-secondary mb-2">$82,7853</h3> </div>
												</div>
												<div class="col-4">
													<div class="icon1 bg-secondary my-auto  float-end"> <i class="las la-hand-holding-usd"></i> </div>
								...
								<div class="col-xxl-3 col-xl-3 col-lg-3 col-md-3">
									<div class="card">
										<div class="card-body">
											<div class="row">
												<div class="col-8">
													<div class="mt-0 text-start"> <span class="font-weight-semibold">Rappels</span>
														<h3 class="mb-0 mt-1 text-primary mb-2">124</h3>
													</div>
												</div>
												<div class="col-4">
								...
								<div class="col-xxl-3 col-xl-3 col-lg-3 col-md-3">
									<div class="card">
										<div class="card-body">
											<div class="row">
												<div class="col-8">
													<div class="mt-0 text-start"> <span class="font-weight-semibold">RDV sur l'agenda partagé</span>
														<h3 class="mb-0 mt-1 text-danger mb-2">7</h3>
													</div>
												</div>
												<div class="col-4">
								...
								<div class="card">
									<div class="card-header border-0 responsive-header">
										...
										<div class="card-options">
											<div class="btn-list">
												<a  href="javascript:void(0);" class="btn  btn-outline-light text-dark float-start d-flex my-sm-0 my-1"><span class="dot-label bg-light4 me-2 my-auto"></span>Income</a>
												<a  href="javascript:void(0);" class="btn  btn-outline-light text-dark float-start d-flex my-sm-0 my-1"><span class="dot-label bg-primary me-2 my-auto"></span>Expense</a>
											...
											<table class="table table-vcenter text-nowrap mb-0 invoice-table">
												...
												<tbody>
													<tr class="border-bottom">
														...
														<td class="text-start fs-13"><h6 class="mb-0 fs-14 font-weight-semibold">$15,426</h6></td>
														<td>
													...
													<tr class="border-bottom">
														...
														<td class="text-start fs-13"><h6 class="mb-0 fs-14 font-weight-semibold">$1421</h6></td>
														<td>
													...
													<tr class="border-bottom">
														...
														<td class="text-start fs-13"><h6 class="mb-0 fs-14 font-weight-semibold">$8427</h6></td>
														<td>
													...
													<tr class="">
														...
														<td class="text-start fs-13"><h6 class="mb-0 fs-14 font-weight-semibold">$12,452</h6></td>
														<td>
