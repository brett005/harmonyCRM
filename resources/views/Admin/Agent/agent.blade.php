							...
							<div class="col-xxl-12 col-xl-3 col-lg-3 col-md-3">
								<div class="card">
									<div class="card-body">
										<div class="row">
											<div class="col-8">
												<div class="mt-0 text-start"> <span class="font-weight-semibold">Argumenté</span>
													<h3 class="mb-0 mt-1 text-success mb-2">6,578</h3>
												</div>
											</div>
											<div class="col-4">
												<div class="icon1 bg-success my-auto  float-end"> <i class="feather feather-briefcase"></i>
							...
							<div class="col-xxl-3 col-xl-3 col-lg-3 col-md-3">
								<div class="card">
									<div class="card-body">
										<div class="row">
											<div class="col-8">
												<div class="mt-0 text-start"> <span class="font-weight-semibold">Fiches</span>
													<h3 class="mb-0 mt-1 text-danger mb-2">7</h3>
												</div>
											</div>
											<div class="col-4">
												<div class="icon1 bg-success my-auto  float-end"> <i class="las la-cubes"></i> </div>
											</div>
										</div>
									</div>
								</div>
								...
								<div class="col-xxl-3 col-xl-3 col-lg-3 col-md-3">
									<div class="card">
										<div class="card-body">
											<div class="row">
												<div class="col-8">
													<div class="mt-0 text-start"> <span class="font-weight-semibold">Heure présence</span>
														<h3 class="mb-0 mt-1 text-success mb-2">6,578</h3>
													</div>
												</div>
												<div class="col-4">
													<div class="icon1 bg-primary my-auto  float-end"> <i class="las la-city"></i> </div>
												</div>
											</div>
										</div>
									</div>
								...
								<div class="col-xxl-3 col-xl-3 col-lg-3 col-md-3">
									<div class="card">
										<div class="card-body">
											<div class="row">
												<div class="col-8">
													<div class="mt-0 text-start"> <span class="font-weight-semibold">Debrief</span>
													<h3 class="mb-0 mt-1 text-secondary mb-2">$82,7853</h3> </div>
												</div>
												<div class="col-4">
													<div class="icon1 bg-danger my-auto  float-endicon1 bg-danger my-auto  float-end"> <i class="las la-hand-holding-usd"></i> </div>
												</div>
											</div>
										</div>
									</div>
								...
								<div class="col-xxl-3 col-xl-3 col-lg-3 col-md-3">
									<div class="card">
										<div class="card-body">
											<div class="row">
												<div class="col-8">
													<div class="mt-0 text-start"> <span class="font-weight-semibold">Pauses</span>
														<h3 class="mb-0 mt-1 text-primary mb-2">124</h3>
													</div>
												</div>
												<div class="col-4">
													<div class="icon1 bg-secondary brround my-auto  float-end"> <i class="las la-building"></i> </div>
												</div>
											</div>
										</div>
									</div>
								...
								<div class="col-xxl-3 col-xl-3 col-lg-3 col-md-3">
									<div class="card">
										<div class="card-body">
											<div class="row">
												<div class="col-8">
													<div class="mt-0 text-start"> <span class="font-weight-semibold">Heure production</span>
														<h3 class="mb-0 mt-1 text-danger mb-2">7</h3>
													</div>
												</div>
												<div class="col-4">

													<div class="icon1 bg-primary my-auto  float-end"> <i class="las la-cubes"></i> </div>
												</div>
											</div>
										</div>
									</div>
                            ...
                            <div class="modal-dialog modal-dialog-centered" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h6 class="modal-title">Create New Event</h6><button aria-label="Close" class="btn-close" data-bs-dismiss="modal" ><span aria-hidden="true">&times;</span></button>
                                    </div>
                                    <div class="modal-body">
                                        <form action="calendar" id="mainFormCalendar" method="post" name="mainFormCalendar">
                                            ...
                                            <div class="d-flex mg-t-15 mg-lg-t-30">
                                                <button class="btn btn-primary me-4" >Save</button>
                                                <a class="btn btn-light" data-bs-dismiss="modal" href="">Discard</a>
                                            </div>
