                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                <label class="form-label mb-0 mt-2">Téléphoner</label>
                                            </div>
                                            <div class="col-md-3">
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-md-3">
                                                <label class="form-label mb-0 mt-2">Alt.Recherche de téléphone </label>
                                            </div>
                                            <div class="col-md-3">
                                    ...
                                    <div class="form-group ">
                                        <div class="row">
                                            <div class="col-md-3">
                                                <label class="form-label mb-0 mt-2">Dérnier</label>
                                            </div>
                                            <div class="col-md-3">
                                                <input type="text" class="form-control" placeholder="Dérnier">
                                            </div>
                                            <div class="col-md-3">
                                    ...
                                    <div class="form-group ">
                                        <div class="row">
                                            <div class="col-md-3">
                                                ...
                                                <label class="form-label mb-0 mt-2">Téléphone composé </label>
                                            </div>
                                            <div class="col-md-3">
                                                <input type="text" class="form-control" placeholder="Numéro composé ">
                                            </div>
                                            <div class="col-md-3">
                                    ...
                                    <h4> Options de recherche journal archivé</h4>
                                    <div class="form-group ">
                                        <div class="row">
                                            <div class="col-md-3">
                                                <label class="form-label mb-0 mt-2">Identifiant du prospect </label>
