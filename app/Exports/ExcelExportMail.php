...
use DB;
class ExcelExportMail implements WithHeadings, FromCollection, WithEvents, Responsable
{
    /**
    ...
    */
    ...
    {
        return DB::table($this->table)->where([['contact_email','<>',''],['contact_email1','']])
                                      ->orWhereColumn('contact_email','<>','contact_email1')->get();
    }
