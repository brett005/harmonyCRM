...
use DB;
class ExportMOBILECLient implements WithHeadings, FromCollection, WithEvents, Responsable
{
    /**
    ...
    */
    ...
    public function collection()
    {
        ...
        'contact_email1',
        'CMK_S_FIELD_DMC_OUT',
        'Commentaire_call1')->where('numero_appeler','LIKE','6%')
                                        ->orWhere('numero_appeler','LIKE','7%')
                                        ->get();
