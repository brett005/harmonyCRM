...
use DB;
class ExportFAXCLient implements WithHeadings, FromCollection, WithEvents, Responsable
{
    /**
    ...
    */
    ...
    {
        return DB::table($this->table)->select( 'contact_date_fiche',
        'pour_centre',
        'date_chargement',
        'contact_qualif1',
        'id_total',
        ...
        'contact_email1',
        'CMK_S_FIELD_DMC_OUT',
        'Commentaire_call1')->where('numero_appeler','LIKE','1%')
                                    ->orWhere('numero_appeler','LIKE','2%')
                                    ->orWhere('numero_appeler','LIKE','3%')
                                    ->orWhere('numero_appeler','LIKE','4%')
                                    ->orWhere('numero_appeler','LIKE','5%')
                                    ->orWhere('numero_appeler','LIKE','9%')
                                    ->get();
    }
